...
public class ViewVersionReplace implements ReplaceViewVersion {
  ...
  public ViewVersion apply() {
    ...
    if (!viewRepresentationsToAdd.isEmpty()) {
      long timestampMillis = System.currentTimeMillis();
      int newVersion = viewVersion.versionId() + 1;

      return ImmutableViewVersion.builder()
          .versionId(newVersion)
          .timestampMillis(timestampMillis)
          .schemaId(null != schema ? schema.schemaId() : viewVersion.schemaId())
    ...
    Tasks.foreach(ops)
        ...
        .run(
            taskOps -> {
              ...
              ViewMetadata.Builder builder = ViewMetadata.buildFrom(this.base);
