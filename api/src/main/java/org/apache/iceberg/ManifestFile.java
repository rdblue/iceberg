...
public interface ManifestFile {
  ...
  Types.NestedField VERSION_ID = optional(517, "version", Types.IntegerType.get(), "Version of the manifest");
  Types.NestedField MANIFEST_CONTENT = optional(518, "content", Types.IntegerType.get(),
  ...
  Types.NestedField PARTITION_SUMMARIES = optional(507, "partitions",
      ...
      "List of partition value ranges");
  // next ID to assign: 519

  Schema SCHEMA = new Schema(
      PATH, LENGTH, SPEC_ID, VERSION_ID, MANIFEST_CONTENT,
  ...
  /**
   * @return version ID of the manifest
   */
  int manifestVersion();
